...
class REM_Shortcodes
{
	...
	function __construct(){
        ...
        /***********************************************************************************************/
        /* WP Bakery Page Builder and Divi Modules Support */
        /***********************************************************************************************/
    ...
    function rem_vc_addons_setup(){
    	if (rem_get_option('wpbakery_addons', 'enable') == 'enable') {
	    	include REM_PATH. '/shortcodes/page-builders/all-setting-fields.php';
	    	include REM_PATH. '/shortcodes/page-builders/vc-settings.php';
    ...
    function create_property_frontend(){
        if (isset($_REQUEST) && $_REQUEST != '') {
            ...
            if (isset($_REQUEST['property_id']) && get_post_field( 'post_author', $_REQUEST['property_id'] ) == $current_user_data->ID) {
                ...
                if (isset($_REQUEST['accessibility']) && $_REQUEST['accessibility'] != '') {
		            if (rem_get_option('property_submission_mode') == 'approve' && get_post_status($_REQUEST['property_id']) == 'pending') {
		              	$p_status  = 'pending';
		            } else {
		              	$p_status  = $_REQUEST['accessibility'];
		            }
                } else {
	            ...
	            if (rem_get_option('property_submission_mode') == 'approve') {
	              	...
	              	do_action( 'rem_new_property_submitted', '' );
	            } else {
