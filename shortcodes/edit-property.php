					...
					<div class="row">
						<div class="col-sm-6 col-md-4">
							<select name="accessibility" class="form-control">
								...
								<option <?php echo (get_post_status($_GET['property_id']) == 'draft') ? 'selected' : '' ; ?> value="draft"><?php _e( 'Draft', 'real-estate-manager' ); ?></option>
								<option <?php echo (get_post_status($_GET['property_id']) == 'publish') ? 'selected' : '' ; ?> value="publish"><?php _e( 'Publish', 'real-estate-manager' ); ?></option>
							</select>
						</div>
						<div class="col-sm-6 col-md-4">
